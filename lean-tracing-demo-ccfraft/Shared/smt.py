...
These model-independent utilities query, restrict, and reduce SMT-LIB text.
Live raw and certificate callers use the Lean checked encoder; this module
does not lower model actions or infer entry states. Core restriction selects
assertions, not a replayable subsequence of model actions.
"""
